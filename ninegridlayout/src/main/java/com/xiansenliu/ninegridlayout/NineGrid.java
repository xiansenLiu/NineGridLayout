 ...
 */
    ...
    public NineGrid(@NonNull Context context) {
        this(context, null);
    }

    public NineGrid(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NineGrid(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NineGrid, defStyleAttr, 0);
        mSpace = typedArray.getDimensionPixelSize(R.styleable.NineGrid_child_space, 0);
        typedArray.recycle();
    }

    public NineGrid(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
